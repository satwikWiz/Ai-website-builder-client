...
const RadioField = ({ element }: Props) => {
  ...
  return (
    <div
      ...
      onDragStart={!state.editor.previewMode && !state.editor.liveMode ? (e) => handleDragStart(e, 'radio') : undefined}
    ...
    >
      ...
      <input type="radio" className="mr-2" readOnly={state.editor.liveMode || state.editor.previewMode} />
      <span>Radio</span>
      {state.editor.selectedElement.id === element.id && !state.editor.liveMode && !state.editor.previewMode && (
