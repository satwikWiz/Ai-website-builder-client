...
const TextAreaField = ({ element }: Props) => {
  ...
  return (
    <div
      ...
      onDragStart={!state.editor.previewMode && !state.editor.liveMode ? (e) => handleDragStart(e, 'textarea') : undefined}
    ...
    >
      ...
      <textarea
        ...
        readOnly={state.editor.liveMode || state.editor.previewMode}
      />
      {state.editor.selectedElement.id === element.id && !state.editor.liveMode && !state.editor.previewMode && (
